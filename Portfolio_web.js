...
// include: /tmp/tmpipdrz6so.js
  ...
  (() => {
    ...
    loadPackage({"files": [{"filename": "/AboutBackground.png", "start": 0, "end": 140616}, {"filename": "/AnimalCrossingNewHorizonsMainTheme.mp3", "start": 140616, "end": 1854951}, {"filename": "/ContactBackground.png", "start": 1854951, "end": 1905624}, {"filename": "/F2.png", "start": 1905624, "end": 1908504}, {"filename": "/MainMenuBackground.png", "start": 1908504, "end": 1960511}, {"filename": "/MainMenuTop.png", "start": 1960511, "end": 1977601}, {"filename": "/PlayerSprite.png", "start": 1977601, "end": 1982659}, {"filename": "/PressE.png", "start": 1982659, "end": 1985637}, {"filename": "/Proj1_Bg.png", "start": 1985637, "end": 2054032}, {"filename": "/Proj2_Bg.png", "start": 2054032, "end": 2120131}, {"filename": "/Proj3_Bg.png", "start": 2120131, "end": 2190314}, {"filename": "/Proj4_Bg.png", "start": 2190314, "end": 2262926}, {"filename": "/Proj5_Bg.png", "start": 2262926, "end": 2340169}, {"filename": "/Proj6_Bg.png", "start": 2340169, "end": 2420678}, {"filename": "/ProjectsBackground.png", "start": 2420678, "end": 2480468}, {"filename": "/SoundOff.png", "start": 2480468, "end": 2480660}, {"filename": "/SoundOn.png", "start": 2480660, "end": 2483537}], "remote_package_size": 2483537});

  })();

// end include: /tmp/tmpipdrz6so.js
...
var ASM_CONSTS = {
 ...
 299418: () => { if (typeof(Module['SDL3']) !== 'undefined') { Module['SDL3'].camera = undefined; } },  
 299505: ($0) => { let gamepads = navigator['getGamepads'](); if (!gamepads) { return 0; } let gamepad = gamepads[$0]; if (!gamepad || !gamepad['vibrationActuator']) { return 0; } return 1; },  
 299680: ($0, $1, $2) => { let gamepads = navigator['getGamepads'](); if (!gamepads) { return 0; } let gamepad = gamepads[$0]; if (!gamepad || !gamepad['vibrationActuator']) { return 0; } gamepad['vibrationActuator']['playEffect']('dual-rumble', { 'startDelay': 0, 'duration': 3000, 'weakMagnitude': $2 / 0xFFFF, 'strongMagnitude': $1 / 0xFFFF, }); return 1; },  
 300016: ($0, $1, $2, $3) => { var w = $0; var h = $1; var pixels = $2; var canvasId = UTF8ToString($3); var canvas = document.querySelector(canvasId); if (!Module['SDL3']) Module['SDL3'] = {}; var SDL3 = Module['SDL3']; if (SDL3.ctxCanvas !== canvas) { SDL3.ctx = Browser.createContext(canvas, false, true); if (!SDL3.ctx) { return false; } SDL3.ctxCanvas = canvas; } if (SDL3.w !== w || SDL3.h !== h || SDL3.imageCtx !== SDL3.ctx) { SDL3.image = SDL3.ctx.createImageData(w, h); SDL3.w = w; SDL3.h = h; SDL3.imageCtx = SDL3.ctx; } var data = SDL3.image.data; var src = pixels / 4; if (SDL3.data32Data !== data) { SDL3.data32 = new Int32Array(data.buffer); SDL3.data32Data = data; } var data32 = SDL3.data32; data32.set(HEAP32.subarray(src, src + data32.length)); SDL3.ctx.putImageData(SDL3.image, 0, 0); return true; },  
 ...
 312220: () => { var div = document.getElementById('SDL3_fill_document_background_elements'); if (div) { if (div.SDL3_canvas_nextsib) { div.SDL3_canvas_parent.insertBefore(div.SDL3_canvas, div.SDL3_canvas_nextsib); } else { div.SDL3_canvas_parent.appendChild(div.SDL3_canvas); } while (div.firstChild) { document.body.insertBefore(div.firstChild, div); } div.SDL3_canvas.style.position = div.SDL3_canvas.SDL3_original_position; div.SDL3_canvas.style.top = div.SDL3_canvas.SDL3_original_top; div.SDL3_canvas.style.left = div.SDL3_canvas.SDL3_original_left; div.remove(); } },  
 312779: () => { if (window.matchMedia) { if (typeof(Module['SDL3']) === 'undefined') { Module['SDL3'] = {}; } var SDL3 = Module['SDL3']; SDL3.eventHandlerThemeChanged = function(event) { _Emscripten_SendSystemThemeChangedEvent(); }; SDL3.themeChangedMatchMedia = window.matchMedia('(prefers-color-scheme: dark)'); SDL3.themeChangedMatchMedia.addEventListener('change', SDL3.eventHandlerThemeChanged); } },  
